...
<%@page import="com.univ.DAO.ImageDAO"%>
<html lang="en">
...
<% ImageDAO dao=new ImageDAO();
  List<Vector> lst=   dao.getImageData();
%>
    <!-- Products Start -->
              ...
              <% for(Vector v1:lst){ %> 
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="img/<%= (String)v1.get(1) %>" alt="">
                        <h6 class="mb-3"><%= (String)v1.get(2) %></h6>
                        <h5 class="text-primary mb-0"><%= (Integer)v1.get(3) %></h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href="AddCart?iid=<%= v1.get(0) %>">"><i class="bi bi-cart text-white"></i></a>
