...
<body>
    ...
    <% List lst12=null;
       ...
       if(hs!=null)
       {
       lst12=(List)hs.getAttribute("user");   
       }
    %>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
             <% if(lst12!=null && !lst12.isEmpty()){ %>
                ...
                <a href="login.jsp" class="nav-item nav-link">Sign-Out</a>
                <a href="showcart.jsp"><img src="img/cart.jpg" height="20" width="20" ></a><%= hs.getAttribute("val") %>
                <% }else{ %>
